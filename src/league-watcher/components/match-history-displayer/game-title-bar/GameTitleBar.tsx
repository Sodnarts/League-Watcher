...
import {
    gameTitleBarStyles,
    typographyTheme,
} from 'src/league-watcher/components/match-history-displayer/game-title-bar/GameTitleBarStyles';
import { TeamChart } from 'src/league-watcher/components/match-history-displayer/game-title-bar/TeamChart';
import { calculateKDA } from 'src/league-watcher/components/match-history-displayer/utils/calculateKDA';
import { getSummoner } from 'src/league-watcher/components/match-history-displayer/utils/getSummoner';
import { trimName } from 'src/league-watcher/components/match-history-displayer/utils/trimName';
